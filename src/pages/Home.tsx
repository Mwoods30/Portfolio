...
function Home() {
  ...
  const projects = [
    ...
    },
    {
      id: 'square-sprint',
      title: 'Square Sprint',
      subtitle: 'Unity WebGL platformer',
      img: '/square-sprint.svg',
      desc: 'A browser-playable Unity platformer exported to WebGL and embedded directly into the portfolio with fullscreen support.',
      primaryButton: { text: 'Play Now', onClick: () => navigate('/square-sprint'), external: false as const },
      githubHref: 'https://github.com/Mwoods30',
      tech: ['Unity', 'C#', 'WebGL'],
      year: '2026',
      featured: false,
